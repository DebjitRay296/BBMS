...
<div style="max-width:100%">
  <img class="mySlides"  src="bb.jpg" >
  <img class="mySlides"  src="bb1.png" >
</div>
<script>
var myIndex = 0;
carousel();
...
<body>
  ...
  {
  %>
  <center><font color="red" size="5">Invalid Input. Please Try Again!!!</font></center>
  <%
  }
  %>
 <center><h1>Enter Your Details to Request for Blood</hl></center>
...
<input type="text" name="units required" placeholder="Units Required" required>
